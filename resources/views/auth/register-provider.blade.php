            ...
            <div class="col-md-8">
                <div class="card shadow border-primary">
                    <div class="card-header bg-primary text-white">
                        <h4 class="mb-0">Service Provider Registration</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('register.provider') }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <x-text-input name="name" required class="form-control" />
                            </div>

                            <div class="mb-3">
                                <x-input-label for="email" value="Email" class="form-label" />
                                <x-text-input name="email" type="email" required class="form-control" />
                            </div>
                            ...
                            <div class="mb-3">
                                <x-input-label for="service_category" value="Service Category" class="form-label" />
                                <select name="service_category" required class="form-select">
                                    <option>Engine Repair</option>
                                    <option>Tyre Change</option>
                                    <option>Battery</option>
                                    <option>Oil Change</option>
                                    <option>Mirror Change</option>
                                    <option>Other</option>
                                </select>
                            </div>
